...
import useCreateStripeCustomer from "hooks/payment/useCreateStripeCustomer";

const AddCustomerDetail = () => {
  const navigate = useNavigate();
  const [createStripeCustomer, loading] = useCreateStripeCustomer();
        ...
        <Formik
          ...
          onSubmit={async (values, actions) => {
            ...
            try {
              ...
              if (result) {
                toast("Customer Detail Successfully Added");
...
export default withApollo()(AddCustomerDetail);
